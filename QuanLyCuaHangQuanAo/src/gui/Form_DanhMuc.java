...
public class Form_DanhMuc extends JPanel {
    ...
    private void initComponents() {
        ...
        // Khởi tạo bảng
        tableDM = new TBL_DM();
        table = tableDM.getTable();
        tableModel =  tableDM.getTableModel();
        
        // Thêm các panel vào leftPanel
        leftPanel.add(createTopPanel(), BorderLayout.NORTH);
        leftPanel.add(tableDM.createTablePanel(table, tableModel), BorderLayout.CENTER);
        
        // Lấy references cho table và tableModel
        table = tableDM.getTable();
        tableModel = tableDM.getTableModel();
